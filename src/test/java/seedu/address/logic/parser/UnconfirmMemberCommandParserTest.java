...
public class UnconfirmMemberCommandParserTest {
    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, UnconfirmMemberCommand.MESSAGE_USAGE);

    private UnconfirmMemberCommandParser parser = new UnconfirmMemberCommandParser();
    ...
    public void parse_invalidArgs_returnsParseException() {
        ...
        // missing prefix
        assertParseFailure(parser, "CS2103T #1", MESSAGE_INVALID_FORMAT);
    }

    @Test
    public void parseValidArgs_returnsUnconfirmMemberCommand() {
        ...
        UnconfirmMemberCommand targetCommand = new UnconfirmMemberCommand(groupName1, courseMates1);
        ...
        assertParseSuccess(parser, "group 2 -cm Bob -cm Alice",
                new UnconfirmMemberCommand(groupName2, courseMates2));
    }
}
